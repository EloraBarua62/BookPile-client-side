    ...
    return (
        <div className='w-full '>
            <div className='px-16 my-16'>
                ...
                <h1 className='text-4xl text-amber-200 uppercase font-bold text-center py-1'>Add new books</h1>
                <div className='w-full bg-amber-500' style={{ height: '2px' }}></div>
            </div>
            <div className="w-11/12 md:w-3/4 xl:w-1/2 h-4/5 bg-amber-500 mx-auto mt-10 p-10">
                <form onSubmit={handleSubmit(onSubmit)} className='text-center'>
                    ...
                    <input type="text" placeholder="Supplier's name" {...register("supplier")} className='w-3/5 h-10 m-3 rounded-lg pl-3' />
