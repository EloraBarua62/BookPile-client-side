  ...
  return (
    <div className="mx-auto max-w-xs flex flex-col rounded-md border-solid border-4 md:border-8 bg-white border-amber-500 hover:border-white">
      <img
        src={img}
        alt=""
        className="border-4 border-amber-500 w-3/4 h-80 mx-auto my-3"
      />
      <div className="px-5 text-left">
        ...
        <button
          onClick={() => {
            handleRemoveItem(book._id);
          }}
          type="button"
          class="bg-amber-600 hover:bg-amber-700 text-white my-5 px-5 py-3 rounded-lg text-xl font-bold"
        >
          Delete
        </button>
      </div>
