...
//     return (
//         <div className='w-3/4 h-1/4 mx-auto mt-10 grid sm:grid-cols-1 md:grid-cols-2 border rounded-md border-solid border-4  border-amber-700 hover:border-white'>
