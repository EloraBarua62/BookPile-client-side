    ...
    return (
        <div className='w-full '>
            <div className='px-16 my-16'>
                ...
                <h1 className='text-4xl text-amber-200 uppercase font-bold text-center py-1'>update book</h1>
                <div className='w-full bg-amber-500' style={{ height: '2px' }}></div>
            </div>
            <div className='w-3/4 h-1/4 mx-auto mt-10 py-10 grid grid-cols-1 lg:grid-cols-2 rounded-md bg-slate-800 shadow-2xl shadow-black'>
                ...
                <div className=' text-amber-300 my-5 mx-5 py-10'>
                    ...
                    {
                        book.quantity > 0 ?
                            <button onClick={() => { handleDeliver(book._id, book.quantity) }} type="button" class="bg-amber-600 hover:bg-amber-500 text-white m-5 px-5 py-3 rounded-lg text-xl font-bold">Deliver</button>
                            :
                            <div>
